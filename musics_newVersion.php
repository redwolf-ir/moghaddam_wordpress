<?php
    /*
     * Template Name: Musics Page (NEW VERSION) - RedwolF
     */
?>
...
<body>
    ...
    <section class="musics_single_page">
        <div class="container">
            <div class="single-title">
                ...
                <form id="live-search" action="">
                    <input type="text" id="filter" placeholder="نام ترانه را اینجا وارد کنید...">
                </form>
            </div>
            <div class="music-part-singlepage">
                <figure>
                    <audio id="audioarea" controls src="./musics/06_-_california_gurls_feat._snoop_dogg.mp3">
                        Your browser does not support the
                        <code>audio</code> element.
                    </audio>
                </figure>
                
                <ul id="tabs" class="music_tabss">
                    <li><a href="#" id="tab1">ترانه‌های قدیمی</a></li>
                    <li><a href="#" id="tab2">ترانه‌های جدید</a></li>
                </ul>
                <div class="wrapper" id="tab1C">
                    <ul id="mplaylist_single">
                        <?php $args = array( 'post_type' => 'musics', 'cat' => '2', );$the_query = new WP_Query( $args ); ?>   
                ...
                <div class="wrapper" id="tab2C">
                    <ul id="mplaylist_single_2">
                        <?php $args = array( 'post_type' => 'musics', 'cat' => '1', );$the_query = new WP_Query( $args ); ?>   
                    <?php if ( $the_query->have_posts() ) : ?><?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>                 
                        <li musicurl="<?php $fields = get_fields(); if( $fields ): ?><?php foreach( $fields as $name => $value ): ?><?php echo $value; ?><?php endforeach; ?><?php endif; ?>">
                            <i><span class="icon-play2"></span></i>
                            <h6><?php the_title(); ?></h6>
        ...
        <a href="<?php echo home_url(); ?>/#musics">بازگشت به صفحه قبل</a>
        </div>
    </section>
